...
GET_FIRST_EP = 199 # set S01E01 to 'wanted'; set all other episode status to 'skipped'. This status should never end up in the DB.
...
class StatusStrings:
    def __init__(self):
        self.statusStrings = {UNKNOWN: "Unknown",
                              ...
                              ARCHIVED: "Archived",
                              IGNORED: "Ignored",
                              GET_FIRST_EP: "Get first episode only"}
